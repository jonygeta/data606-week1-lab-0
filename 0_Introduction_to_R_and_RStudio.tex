...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{girls)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{0_Introduction_to_R_and_RStudio_files/figure-latex/plot-girls-vs-year-1.pdf}
...
\includegraphics{0_Introduction_to_R_and_RStudio_files/figure-latex/plot-girls-vs-year-line-1.pdf}
...
\includegraphics{0_Introduction_to_R_and_RStudio_files/figure-latex/plot-total-vs-year-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{proporetion <-}\StringTok{ }\NormalTok{arbuthnot}\OperatorTok{$}\NormalTok{boys }\OperatorTok{/}\StringTok{ }\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{boys }\OperatorTok{+}\StringTok{ }\NormalTok{arbuthnot}\OperatorTok{$}\NormalTok{girls)}
\KeywordTok{plot}\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{year, proporetion, }\DataTypeTok{type =} \StringTok{"l"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{0_Introduction_to_R_and_RStudio_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{range}\NormalTok{(present}\OperatorTok{$}\NormalTok{year)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{proporetion <-}\StringTok{ }\NormalTok{present}\OperatorTok{$}\NormalTok{boys }\OperatorTok{/}\StringTok{ }\NormalTok{(present}\OperatorTok{$}\NormalTok{boys }\OperatorTok{+}\StringTok{ }\NormalTok{present}\OperatorTok{$}\NormalTok{girls)}
\KeywordTok{plot}\NormalTok{(present}\OperatorTok{$}\NormalTok{year, proporetion, }\DataTypeTok{type =} \StringTok{"l"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{0_Introduction_to_R_and_RStudio_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{present}\OperatorTok{$}\NormalTok{total <-}\StringTok{ }\NormalTok{present}\OperatorTok{$}\NormalTok{boys}\OperatorTok{+}\NormalTok{present}\OperatorTok{$}\NormalTok{girls}
\NormalTok{present[present}\OperatorTok{$}\NormalTok{total }\OperatorTok{==}\StringTok{ }\KeywordTok{max}\NormalTok{(present}\OperatorTok{$}\NormalTok{total),}\StringTok{"year"}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
